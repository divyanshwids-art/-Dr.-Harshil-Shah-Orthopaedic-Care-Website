      ...
      <section className="hero-oneline-section">
        <div className="hero-oneline-bar">
          ...
          <div className="hero-ol-item">
            <div className="hero-ol-icon">
              <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="#2D67A8" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
                <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
                <circle cx="12" cy="7" r="4" />
              </svg>
            </div>
            <div className="hero-ol-text">
              <span className="hero-ol-t1">Personalised</span>
              <span className="hero-ol-t2">Treatment Plans</span>
            </div>
          </div>
          ...
          <div className="hero-ol-item">
            ...
            <div className="hero-ol-text">
              <span className="hero-ol-t1">Long-Term Mobility</span>
              <span className="hero-ol-t2">Focus</span>
            </div>
          </div>
          ...
          <div className="hero-ol-item">
            ...
            <div className="hero-ol-text">
              <span className="hero-ol-t1">Compassionate</span>
              <span className="hero-ol-t2">Patient Care</span>
            </div>
          </div>

          {/* Buttons pushed to RIGHT */}
          <div className="hero-ol-btns-right">
            <Link to="/appointment" className="hero-ol-btn-primary">
