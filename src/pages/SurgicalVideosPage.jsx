            ...
            <div className="surgical-cta-grid">
              <div className="surgical-cta-left">
                ...
                <p className="surgical-cta-sub">
                  ...
                  Monday – Saturday &nbsp;|&nbsp; Direct Clinic Desk: +91 93167 53985
                </p>
              </div>
              <div className="surgical-cta-right">
                ...
                <Link to="/contact" className="surgical-cta-secondary">
                  Contact the Clinic
                </Link>
                <a
                  href="https://wa.me/919316753985?text=Hello%2C%20I%20have%20questions%20regarding%20surgical%20options."
                  target="_blank"
                  rel="noreferrer"
